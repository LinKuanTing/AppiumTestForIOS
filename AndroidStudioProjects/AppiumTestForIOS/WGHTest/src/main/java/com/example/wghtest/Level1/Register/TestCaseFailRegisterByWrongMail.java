...
public class TestCaseFailRegisterByWrongMail extends WDFnL1Register {
    ...
    protected static String _strCHRegisterMsg = "請輸入有效之電子郵件資料";
    protected static String _strENRegisterMsg = "Need Valid E-mail";

    protected static String _strFileName = "TestDataFailRegisterByWrongMail";
