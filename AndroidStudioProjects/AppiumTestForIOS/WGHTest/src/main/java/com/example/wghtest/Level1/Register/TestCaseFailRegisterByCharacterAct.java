...
public class TestCaseFailRegisterByCharacterAct extends WDFnL1Register {
    ...
    protected static String _strCHRegisterMsg = "帳號至少要1個英數字";
    protected static String _strENRegisterMsg = "Need Valid Account";

    protected static String _strFileName = "TestDataFailRegisterByCharacterAct";
