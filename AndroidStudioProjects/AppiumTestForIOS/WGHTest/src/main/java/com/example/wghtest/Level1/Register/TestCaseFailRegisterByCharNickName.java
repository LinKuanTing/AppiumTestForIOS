...
public class TestCaseFailRegisterByCharNickName extends WDFnL1Register {
    ...
    protected static String _strCHRegisterMsg = "暱稱至少要1個中英數字";
    protected static String _strENRegisterMsg = "Need Nick Name";

    protected static String _strFileName = "TestDataFailRegisterByCharNickName";
